...
/**
 * Kiểm tra phương thức cải tiến tính toán không gian lưu trữ metadata
 */
async function testOptimizedStorageAllocation() {
  console.log("🧪 BẮT ĐẦU TEST TỐI ƯU HÓA CẤP PHÁT KHÔNG GIAN CHO METADATA");
  ...
  try {
    ...
    console.log("\n📝 BƯỚC 1: Tạo token test với metadata cơ bản...");
    ...
    tokenBuilder
      ...
      .addTokenMetadata(
        ...
        {
          "description": "Token để kiểm thử tối ưu hóa cấp phát không gian metadata"
        }
      );
...
// Chạy các test
testOptimizedStorageAllocation().catch(err => {

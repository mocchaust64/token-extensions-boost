...
exports.InterestBearingExtension = void 0;
const spl_token_1 = require("@solana/spl-token");
/**
 * Class cho tính năng Interest-Bearing (hưởng lãi) cho token
 */
class InterestBearingExtension {
    /**
     ...
     */
    static createInitializeInterestBearingMintInstruction(mint, rateAuthority, rate, programId = spl_token_1.TOKEN_2022_PROGRAM_ID) {
        return (0, spl_token_1.createInitializeInterestBearingMintInstruction)(mint, rateAuthority, rate, programId);
    }
    /**
     ...
     */
    static createUpdateRateInterestBearingMintInstruction(mint, rateAuthority, rate, programId = spl_token_1.TOKEN_2022_PROGRAM_ID) {
     ...
     */
    static calculateInterest(initialAmount, rate, timeInSeconds) {
        // Công thức tính lãi:
...
exports.InterestBearingExtension = InterestBearingExtension;

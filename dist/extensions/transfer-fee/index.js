...
class TransferFeeToken extends token_1.Token {
    ...
    async withdrawFeesFromAccounts(accounts, destination, withdrawAuthority) {
        ...
        const authorityPublicKey = authority instanceof web3_js_1.Keypair
            ...
            : authority;
        try {
            const transaction = new web3_js_1.Transaction().add((0, spl_token_1.createWithdrawWithheldTokensFromAccountsInstruction)(this.mint, destination, authorityPublicKey, [], accounts, spl_token_1.TOKEN_2022_PROGRAM_ID));
            return await (0, web3_js_1.sendAndConfirmTransaction)(this.connection, transaction, [authority]);
        }
        catch (error) {
    ...
    async withdrawFeesFromMint(destination, withdrawAuthority) {
        ...
        const authorityPublicKey = authority instanceof web3_js_1.Keypair
            ...
            : authority;
        try {
            const transaction = new web3_js_1.Transaction().add((0, spl_token_1.createWithdrawWithheldTokensFromMintInstruction)(this.mint, destination, authorityPublicKey, [], spl_token_1.TOKEN_2022_PROGRAM_ID));
            return await (0, web3_js_1.sendAndConfirmTransaction)(this.connection, transaction, [authority]);
        }
        catch (error) {
